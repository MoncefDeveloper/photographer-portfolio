...
<div class="manage manage1-2">
    <h1>Manage Gallery (<?php echo $title ?>)</h1>
    <div class="img"><img alt='img' loading='lazy' src="<?php echo $image_name_before ?>"></div>
    <div class="chose">
    ...
    <table class="content content2">
        ...
        $x = 1;
        $sql = "SELECT * from tbl_gallery where tbl_gallery.category_id=$new_id order by id desc";
        $stmt = $db->prepare($sql);
        $stmt->execute();
        $row2 = $stmt->fetchAll();
                ...
                foreach ($row2 as $row) {
                    ...
                    echo "
                            <tr>
                                ...
                                <td>$title</td>
                                <td>$category_name</td>
                                <td><div  class='cneter-element'><img alt='img' loading='lazy' src='$image_name'></div></td>
                                <td>$description</td>
                                <td>$key_word</td>
                                <td>$vert</td>
                                <td>$sex</td>
